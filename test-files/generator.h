...
#ifdef __cpp_impl_coroutine
#define _CPPCORO_HANDLE_DEFAULT = std::coroutine_handle
#else
#define _CPPCORO_HANDLE_DEFAULT = std::vector
#endif
...
namespace cppcoro {
    ...
    template<typename T, typename Details = NoDetails,
        template <typename...> typename GeneratorHandle _CPPCORO_HANDLE_DEFAULT>
    class generator;
...
// Single-arg destruction bodies (no trailing void() — used within multi-arg expansions)
#define _DESTROY_UNCONDITIONALLY_SINGLE(mem) this->mem.destroy(); this->__constructed.mem=false;
#define _DESTROY_IF_CONSTRUCTED_SINGLE(mem) if (this->__constructed.mem) { _DESTROY_UNCONDITIONALLY_SINGLE(mem) }

// Shared count-dispatch helpers (used by DESTROY_UNCONDITIONALLY, DESTROY_IF_CONSTRUCTED, and CO_DESTROY_MEMBERS)
...
// Variadic DESTROY_UNCONDITIONALLY — destroys 0..10 members unconditionally, in argument order
#define DESTROY_UNCONDITIONALLY_0_MEMBERS()
#define DESTROY_UNCONDITIONALLY_1_MEMBERS(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m1) void()
#define DESTROY_UNCONDITIONALLY_2_MEMBERS(m1,m2) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) void()
#define DESTROY_UNCONDITIONALLY_3_MEMBERS(m1,m2,m3) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) void()
#define DESTROY_UNCONDITIONALLY_4_MEMBERS(m1,m2,m3,m4) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) void()
#define DESTROY_UNCONDITIONALLY_5_MEMBERS(m1,m2,m3,m4,m5) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) _DESTROY_UNCONDITIONALLY_SINGLE(m5) void()
#define DESTROY_UNCONDITIONALLY_6_MEMBERS(m1,m2,m3,m4,m5,m6) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) _DESTROY_UNCONDITIONALLY_SINGLE(m5) _DESTROY_UNCONDITIONALLY_SINGLE(m6) void()
#define DESTROY_UNCONDITIONALLY_7_MEMBERS(m1,m2,m3,m4,m5,m6,m7) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) _DESTROY_UNCONDITIONALLY_SINGLE(m5) _DESTROY_UNCONDITIONALLY_SINGLE(m6) _DESTROY_UNCONDITIONALLY_SINGLE(m7) void()
#define DESTROY_UNCONDITIONALLY_8_MEMBERS(m1,m2,m3,m4,m5,m6,m7,m8) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) _DESTROY_UNCONDITIONALLY_SINGLE(m5) _DESTROY_UNCONDITIONALLY_SINGLE(m6) _DESTROY_UNCONDITIONALLY_SINGLE(m7) _DESTROY_UNCONDITIONALLY_SINGLE(m8) void()
#define DESTROY_UNCONDITIONALLY_9_MEMBERS(m1,m2,m3,m4,m5,m6,m7,m8,m9) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) _DESTROY_UNCONDITIONALLY_SINGLE(m5) _DESTROY_UNCONDITIONALLY_SINGLE(m6) _DESTROY_UNCONDITIONALLY_SINGLE(m7) _DESTROY_UNCONDITIONALLY_SINGLE(m8) _DESTROY_UNCONDITIONALLY_SINGLE(m9) void()
#define DESTROY_UNCONDITIONALLY_10_MEMBERS(m1,m2,m3,m4,m5,m6,m7,m8,m9,m10) _DESTROY_UNCONDITIONALLY_SINGLE(m1) _DESTROY_UNCONDITIONALLY_SINGLE(m2) _DESTROY_UNCONDITIONALLY_SINGLE(m3) _DESTROY_UNCONDITIONALLY_SINGLE(m4) _DESTROY_UNCONDITIONALLY_SINGLE(m5) _DESTROY_UNCONDITIONALLY_SINGLE(m6) _DESTROY_UNCONDITIONALLY_SINGLE(m7) _DESTROY_UNCONDITIONALLY_SINGLE(m8) _DESTROY_UNCONDITIONALLY_SINGLE(m9) _DESTROY_UNCONDITIONALLY_SINGLE(m10) void()
#define DESTROY_UNCONDITIONALLY(...) CO_DESTROY_MEMBERS_CONCAT(DESTROY_UNCONDITIONALLY_,CO_DESTROY_MEMBERS_CONCAT(CO_DESTROY_MEMBERS_COUNT(__VA_ARGS__),_MEMBERS))(__VA_ARGS__)

// Variadic DESTROY_IF_CONSTRUCTED — conditionally destroys 0..10 members (checks flag), in argument order
#define DESTROY_IF_CONSTRUCTED_0_MEMBERS()
#define DESTROY_IF_CONSTRUCTED_1_MEMBERS(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) void()
#define DESTROY_IF_CONSTRUCTED_2_MEMBERS(m1,m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) void()
#define DESTROY_IF_CONSTRUCTED_3_MEMBERS(m1,m2,m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) void()
#define DESTROY_IF_CONSTRUCTED_4_MEMBERS(m1,m2,m3,m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) void()
#define DESTROY_IF_CONSTRUCTED_5_MEMBERS(m1,m2,m3,m4,m5) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m5) void()
#define DESTROY_IF_CONSTRUCTED_6_MEMBERS(m1,m2,m3,m4,m5,m6) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m5) _DESTROY_IF_CONSTRUCTED_SINGLE(m6) void()
#define DESTROY_IF_CONSTRUCTED_7_MEMBERS(m1,m2,m3,m4,m5,m6,m7) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m5) _DESTROY_IF_CONSTRUCTED_SINGLE(m6) _DESTROY_IF_CONSTRUCTED_SINGLE(m7) void()
#define DESTROY_IF_CONSTRUCTED_8_MEMBERS(m1,m2,m3,m4,m5,m6,m7,m8) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m5) _DESTROY_IF_CONSTRUCTED_SINGLE(m6) _DESTROY_IF_CONSTRUCTED_SINGLE(m7) _DESTROY_IF_CONSTRUCTED_SINGLE(m8) void()
#define DESTROY_IF_CONSTRUCTED_9_MEMBERS(m1,m2,m3,m4,m5,m6,m7,m8,m9) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m5) _DESTROY_IF_CONSTRUCTED_SINGLE(m6) _DESTROY_IF_CONSTRUCTED_SINGLE(m7) _DESTROY_IF_CONSTRUCTED_SINGLE(m8) _DESTROY_IF_CONSTRUCTED_SINGLE(m9) void()
#define DESTROY_IF_CONSTRUCTED_10_MEMBERS(m1,m2,m3,m4,m5,m6,m7,m8,m9,m10) _DESTROY_IF_CONSTRUCTED_SINGLE(m1) _DESTROY_IF_CONSTRUCTED_SINGLE(m2) _DESTROY_IF_CONSTRUCTED_SINGLE(m3) _DESTROY_IF_CONSTRUCTED_SINGLE(m4) _DESTROY_IF_CONSTRUCTED_SINGLE(m5) _DESTROY_IF_CONSTRUCTED_SINGLE(m6) _DESTROY_IF_CONSTRUCTED_SINGLE(m7) _DESTROY_IF_CONSTRUCTED_SINGLE(m8) _DESTROY_IF_CONSTRUCTED_SINGLE(m9) _DESTROY_IF_CONSTRUCTED_SINGLE(m10) void()
#define DESTROY_IF_CONSTRUCTED(...) CO_DESTROY_MEMBERS_CONCAT(DESTROY_IF_CONSTRUCTED_,CO_DESTROY_MEMBERS_CONCAT(CO_DESTROY_MEMBERS_COUNT(__VA_ARGS__),_MEMBERS))(__VA_ARGS__)

// Variadic CO_DESTROY_MEMBERS — destroys 0..10 members unconditionally, in argument order (used by CO_RETURN_*)
